...
export default function StartQuiz({ params }: StartQuizProps) {
    ...
    const handleSubmitQuiz = async () => {
        ...
        const response = await fetch("/api/updateLeaderboard", {
            ...
            body: JSON.stringify({
                studentId: localStorage.getItem("studentId"), // Replace with actual student ID
                score,
                topic,
            }),
        });

        const reponsetwo = await fetch(`/api/getRecommendations?studentId=${localStorage.getItem("studentId")}`);
        ...
        return (
            <div className="flex items-center justify-center h-screen bg-gray-100">
                <div className="bg-white p-8 rounded shadow-md w-96">
                    ...
                    <button
                        onClick={() => router.push(`/${username}/quiz/leaderboard?topic=${topic}`)}
                    ...
                    <button
                        onClick={() => router.push(`/${username}/quiz`)}
