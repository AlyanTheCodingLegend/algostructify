...
const CircularQueue_1 = __importDefault(require("../_datastructures/CircularQueue"));
const react_toastify_1 = require("react-toastify");
function Page() {
    const [queue] = (0, react_1.useState)(new CircularQueue_1.default(7));
    ...
    const renderQueue = () => {
        if (queue.isEmpty())
            return <div>No nodes in the Queue.</div>;
        const nodes = [];
