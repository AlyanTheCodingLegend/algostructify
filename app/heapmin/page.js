...
const HeapMin_1 = __importDefault(require("../_datastructures/HeapMin"));
const TreeNode_1 = require("./TreeNode");
function Page() {
    const [heap] = (0, react_1.useState)(new HeapMin_1.default());
    ...
    const renderHeap = () => {
        if (heap.size() === 0)
            return <div>No nodes in the Min Heap.</div>;
